...
### 🛠️ Best works:
#### Binary tree:
  Build binary tree structure with add, find and remove commands. The best feature is that it can store arithmetic operations, convert any combination of 21 standart function (like sin, cos, plus, minuc, etc.) into binary tree, and when it can
...
#### Other works:
  I also have other works, such as fully autonomous silly "math" programming language with full pipeline from lexems to binary, different implementations of hashmap, stack, doubly linked list implementations with very beautiful dumps and verifiers. Some assembly programs, like Frame printing program, or "printf" implementation and so much more.

### 🎓 Skill set:
Skills ranked from best studied to least studied from top to bottom.
  | languages        | web                | MCU                | utilities          |
  |------------------|--------------------|--------------------|--------------------|
  | C                | HTML/CSS           | RPI                | Git                |
  | C++              | JavaScript         | Arduino            | Linux/WSL          |
  | Assembly x86‑66  |                    | PWM, I2C, SMBUS    | VS Code            |
  | Assembly 8086    |                    |                    | Valgrind,Perf      |
  | Python           |                    |                    | TD, GDB, Graphviz  |
  | LaTeX            |                    |                    | Makefile           |
  | Bash/Bat         |                    |                    |                    |
  | Java             |                    |                    |                    |
